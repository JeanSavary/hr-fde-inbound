...
def _uid() -> str:
    ...
    _COUNTER += 1
    return str(
        uuid.UUID(int=_COUNTER * 7_919 + 0xACE1_0000_0000_0000, version=4)
    )
...
_C = [
    {
        "mc": "MC-847291",
        "name": "Sunrise Transport LLC",
        "phone": "+15125550192",
    },
    {
        "mc": "MC-392847",
        "name": "Blue Ridge Freight Inc",
        "phone": "+14045558234",
    },
    ...
    {
        "mc": "MC-847523",
        "name": "Appalachian Freight LLC",
        "phone": "+19015553218",
    },
    {
        "mc": "MC-302847",
        "name": "Desert Run Transport",
        "phone": "+16025552109",
    },
    {
        "mc": "MC-574839",
        "name": "Midwest Express Inc",
        "phone": "+13125559876",
    },
    {
        "mc": "MC-918273",
        "name": "Southeast Carriers LLC",
        "phone": "+17705551234",
    },
    {
        "mc": "MC-463728",
...
_BOOKED = [
    # ── 12% MARGIN — 2-round ────────────────────────────────────────
    # loadboard_rate=2150, floor=1830, agreed=1890 → margin=12.1%
    (
        "LD-1001",
        "Dallas, TX",
        "Chicago, IL",
        ...
        "positive",
        "2r",
        "Carrier called on Dallas to Chicago dry van. Negotiated from $1,960 ask down to "
        "$1,890 in 2 rounds. Carrier cited deadhead from Oklahoma City.",
        [
            "Carrier had ~150 mi deadhead from Oklahoma City",
            "Rate negotiated from $1,960 ask to $1,890 in 2 rounds",
            "Agreed $1,890 all-in — deal closed",
        ],
    ),
    # ── 12% MARGIN — 2-round reefer ────────────────────────────────
    # loadboard_rate=1850, floor=1575, agreed=1630 → margin=11.9%
    (
        "LD-1002",
        "Atlanta, GA",
        "Miami, FL",
        ...
        "difficulty and reefer fuel costs. 2-round negotiation, settled $1,630.",
        [
            "Carrier raised Miami dead-end concern and reefer fuel",
            "Quick 2-round negotiation — carrier familiar with lane",
            "Agreed $1,630 all-in, temp 34°F confirmed",
        ],
    ),
    # ── 8% MARGIN — 3-round ────────────────────────────────────────
    # loadboard_rate=980, floor=835, agreed=900 → margin=8.2%
    (
        "LD-1003",
        "Los Angeles, CA",
        "Phoenix, AZ",
        ...
        "negotiation. Carrier flagged weight at 44,000 lbs and tarping costs. Agreed $900.",
        [
            ...
            "Agreed $900 all-in — tight margin after hard negotiation",
        ],
    ),
    # ── 8% MARGIN — 3-round ────────────────────────────────────────
    # loadboard_rate=1420, floor=1210, agreed=1305 → margin=8.1%
    (
        "LD-1004",
        "Houston, TX",
        "Memphis, TN",
        ...
        "carrier pushed on fuel costs and Memphis dead-end market. Agreed $1,305.",
        [
            "Carrier cited fuel costs and Memphis as tough reload market",
            "Three rounds before final agreement",
            "Agreed $1,305 all-in — tight margin after extended negotiation",
        ],
    ),
    # ── 12% MARGIN — 2-round reefer ────────────────────────────────
    # loadboard_rate=3200, floor=2720, agreed=2815 → margin=12.0%
    (
        "LD-1006",
        "Salinas, CA",
        "Denver, CO",
        ...
        "Carrier had strong case for long-haul reefer fuel. Settled $2,815 in 2 rounds.",
        [
            "Long-haul 1,140 miles — carrier had valid reefer fuel argument",
            "Pre-cool to 33°F requirement acknowledged",
            "Agreed $2,815 all-in — 2-round deal",
        ],
    ),
    # ── 12% MARGIN — 2-round reefer ────────────────────────────────
    # loadboard_rate=1380, floor=1175, agreed=1215 → margin=12.0%
    (
        "LD-1012",
        "Kansas City, MO",
        "Minneapolis, MN",
        ...
        "Carrier cited temp certification costs. 2-round deal at $1,215.",
        [
    ...
    # ── 15% MARGIN — 1-round quick ─────────────────────────────────
    # loadboard_rate=780, floor=665, agreed=665 → margin=14.7%
    (
        "LD-1015",
        "Philadelphia, PA",
        "Richmond, VA",
        ...
        "Carrier positioned nearby with available reefer. Quick 1-round deal at $665.",
        [
            "Carrier had empty reefer nearby — strong positioning",
            "Short haul 290 miles, dairy at 36°F",
            "Agreed $665 all-in — quick 1-round acceptance",
        ],
    ),
    # ── 15% MARGIN — 1-round quick ─────────────────────────────────
    # loadboard_rate=750, floor=640, agreed=640 → margin=14.7%
    (
        "LD-1018",
        "Louisville, KY",
        "St. Louis, MO",
        ...
        "floor-loaded beverages. Carrier accepted immediately at $640.",
        [
            "Floor-loaded beverages — no pallets, noted by carrier",
            "Carrier was positioning toward St. Louis anyway",
            "Agreed $640 all-in — 1-round quick deal",
        ],
    ),
    # ── 12% MARGIN — 2-round ───────────────────────────────────────
    # loadboard_rate=1280, floor=1090, agreed=1125 → margin=12.1%
    (
        "LD-1020",
        "San Antonio, TX",
        "New Orleans, LA",
        ...
        "Carrier had favorable positioning from SA. 2-round deal at $1,125.",
        [
            "Carrier positioned in San Antonio — minimal deadhead",
            "E-commerce fulfillment, dock lock required confirmed",
            "Agreed $1,125 all-in in 2 rounds",
        ],
    ),
    # ── 15% MARGIN — 1-round quick ─────────────────────────────────
    # loadboard_rate=850, floor=725, agreed=725 → margin=14.7%
    (
        "LD-1025",
        "El Paso, TX",
        "Tucson, AZ",
        ...
        "Quick 1-round deal, carrier repositioning that direction. $725 all-in.",
        [
            "Carrier was repositioning El Paso to Tucson anyway",
            "Solar panels on pallets — edge protectors and tarps confirmed",
            "1-round quick deal at $725 all-in",
        ],
    ),
    # ── 12% MARGIN — 2-round ───────────────────────────────────────
    # loadboard_rate=1180, floor=1005, agreed=1040 → margin=11.9%
    (
        "LD-1030",
        "Harrisburg, PA",
        "Charlotte, NC",
        ...
        "Carrier familiar with lane. Clean 2-round deal at $1,040.",
        [
            "Pad wrap / blanket wrap requirement confirmed",
            "Carrier runs this lane regularly",
            "Agreed $1,040 all-in — 2-round deal",
        ],
    ),
    # ── 8% MARGIN — 3-round ────────────────────────────────────────
    # loadboard_rate=1950, floor=1660, agreed=1795 → margin=7.9%
    (
        "LD-1031",
        "Atlanta, GA",
        "Dallas, TX",
        ...
        "Three rounds of hard negotiation. Carrier pushed to $1,900, settled at $1,795.",
        [
            "Carrier pushed hard citing fuel and long haul — opened at $1,900",
            "Three rounds required — tight margin after extended negotiation",
            "Agreed $1,795 all-in, liftgate at delivery confirmed",
        ],
    ),
    # ── 12% MARGIN — 2-round ───────────────────────────────────────
    # loadboard_rate=1550, floor=1320, agreed=1365 → margin=11.9%
    (
        "LD-1037",
        "Houston, TX",
        "Memphis, TN",
        ...
        "Carrier positioned in Houston. 2-round deal at $1,365.",
        [
            "High-value cargo — carrier confirmed strapping capability",
            "Carrier had truck available in Houston yard",
            "Agreed $1,365 all-in in 2 rounds",
        ],
    ),
    # ── 8% MARGIN — 3-round ────────────────────────────────────────
    # loadboard_rate=1100, floor=935, agreed=1010 → margin=8.2%
    (
        "LD-1043",
        "Atlanta, GA",
        "Jacksonville, FL",
        ...
        "pushed hard on rate. Agreed $1,010.",
        [
            "Over-height 11ft transformer — wide load permit verified",
            "Carrier had step deck with correct securement — limited carrier pool",
            "Agreed $1,010 all-in — specialized equipment justified premium",
        ],
    ),
    # ── 15% MARGIN — 1-round quick ─────────────────────────────────
    # loadboard_rate=550, floor=470, agreed=470 → margin=14.5%
    (
        "LD-1047",
        "Dallas, TX",
        "Houston, TX",
...
def _offer(
    ...
    return {
        ...
        "notes": "",
        "created_at": (
            datetime.fromisoformat(ts_base) + timedelta(minutes=min_offset)
        ).isoformat(),
...
def _build_offers_booked(
    call_id, load_id, mc, loadboard, carrier_ask, agreed, rounds, ts
):
    offers = []
...
def _build_data():
    ...
    for row in _BOOKED:
        ...
        calls.append(
            {
                ...
                "carrier_name": name,
                "lane_origin": origin,
                "lane_destination": dest,
                "equipment_type": equip,
                "load_id": load_id,
                "initial_rate": float(carrier_ask),
                "final_rate": float(agreed),
        ...
        interactions.append(
            _interaction(mc, name, call_id, load_id, "booked", duration, ts)
        )
    ...
    for row in _FAILED:
        ...
        interactions.append(
            _interaction(
                mc, name, call_id, load_id, "negotiation_failed", duration, ts
            )
        )
    ...
    for row in _NO_LOADS:
        ...
        interactions.append(
            _interaction(
                mc, name, call_id, None, "no_loads_available", duration, ts
            )
        )
    ...
    for row in _THINKING:
        ...
        offers.extend(
            _build_offers_thinking(
                call_id, load_id, mc, loadboard, carrier_ask, ts
            )
        )
        interactions.append(
            _interaction(
                mc, name, call_id, load_id, "carrier_thinking", duration, ts
            )
        )
    ...
    for row in _TRANSFERRED:
        ...
        interactions.append(
            _interaction(
                mc, name, call_id, load_id, "transferred_to_ops", duration, ts
            )
        )
    ...
    for row in _DROPPED:
        ...
        calls.append(
            {
                ...
                "sentiment": "neutral",
                "duration_seconds": duration,
                "transcript": T_DROPPED,
                "summary": "Call dropped before negotiation could begin.",
                "key_points": json.dumps(
                    [
                        "Connection lost early in call",
        ...
        interactions.append(
            _interaction(
                mc, name, call_id, load_id, "dropped_call", duration, ts
            )
        )
